...
mod tests {
    ...
    fn create_lightweight_from_json_file_successfully() {
        call_once();
        let lightweight = Lightweight::from_json_file("./src/tests/unit/strength/lightweight_tonnage/data/correct_data.json".to_string());
    ...
    fn create_lightweight_from_json_file_invalid_type() {
        call_once();
        let lightweight = Lightweight::from_json_file("./src/tests/unit/strength/lightweight_tonnage/data/invalid_type.json".to_string());
    ...
    fn create_lightweight_from_json_file_missing_field() {
        call_once();
        let lightweight = Lightweight::from_json_file("./src/tests/unit/strength/lightweight_tonnage/data/empty_field.json".to_string());
        assert!(lightweight.is_err());
    ...
    fn test_number_spatiums() {
        call_once();
        let lightweight = Lightweight::from_json_file("./src/tests/unit/strength/lightweight_tonnage/data/correct_data.json".to_string()).unwrap();
